...
import { UpdateProductModal } from "@/components/modals/edit-product-modal";
      ...
      <Dialog open={showApproveDialog} onOpenChange={setShowApproveDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Set the minimum and maximum prices for "{productToApprove?.name}"
              to approve this product.
            </DialogDescription>
          </DialogHeader>
      ...
      <AlertDialog open={showQueryDialog} onOpenChange={setShowQueryDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to query "{productToQuery?.name}"? This will
              mark the product as queried and require the supplier to make
